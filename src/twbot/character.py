...
class CharacterState:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "ship": {
                "ship_type": self.ship.ship_type,
                "holds_total": self.ship.holds_total,
                "holds_free": self.ship.holds_free,
                "fighters": self.ship.fighters,
                "shields": self.ship.shields,
            },
            "current_sector": self.current_sector,
            "last_known_sector": self.last_known_sector,
            ...
            "scanned_sectors": self.scanned_sectors,
    ...
    def from_dict(cls, data: dict) -> CharacterState:
        ...
        ship = ShipStatus(
            ship_type=ship_data.get("ship_type", "Merchant Cruiser"),
            holds_total=ship_data.get("holds_total", 20),
            holds_free=ship_data.get("holds_free", 20),
            fighters=ship_data.get("fighters", 0),
        ...
        return cls(
            ...
            last_active=data.get("last_active", time()),
            ...
            last_known_sector=data.get("last_known_sector"),
            experience=data.get("experience", 0),
            alignment=data.get("alignment", 0),
            corp_id=data.get("corp_id"),
            trades_completed=data.get("trades_completed", 0),
            total_profit=data.get("total_profit", 0),
            best_trade_profit=data.get("best_trade_profit", 0),
            deaths=data.get("deaths", 0),
            sessions_played=data.get("sessions_played", 0),
            visited_sectors=set(data.get("visited_sectors", [])),
            scanned_sectors=data.get("scanned_sectors", {}),
