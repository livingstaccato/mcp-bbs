...
from mcp_bbs.learning.rules import RuleSet
...
async def test_menu_exploration():
    ...
    try:
        ...
        from twbot.login import _check_kv_validation
...
async def test_extraction_accuracy():
    ...
    from src.mcp_bbs.learning.rules import RuleSet
    from src.mcp_bbs.learning.extractor import KVExtractor
